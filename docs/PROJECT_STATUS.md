...
**Last updated:** 2026-09-18 (Phase 9 increment 1: portfolio analytics)
**Branch:** `main`
...
- Not yet: trade/strategy analytics, performance reports, analytics frontend page (equity chart
...
1. **Phase 9 — Increment 1: portfolio analytics (2026-09-18)** — added the `analytics` module with
...
2. **Phase 8 — Increment 11: Binance testnet smoke-test tooling (2026-09-18)** — added
   ...
   network to testnet).
3. **Phase 8 — Increment 10: Binance fill-fee accounting (2026-09-18)** — `BinanceAdapter.getOrder`
...
4. **Phase 8 — Increment 9: Binance OCO protective brackets (2026-09-18)** — added the optional
...
5. **Phase 8 — Increment 8: Binance Testnet becomes the primary live broker (2026-09-18)** — added the
   ...
   listed).
6. **Phase 8 — Increment 7: frontend live broker monitor + order controls (2026-09-15)** — added the
...
7. **Phase 8 — Increment 6: live account monitor + position reconciliation (2026-09-15)** — added
...
8. **Phase 8 — Increment 5: live order management + emergency controls (2026-09-15)** — added
...
9. **Phase 8 — Increment 4: live bot routing + circuit breaker (2026-09-15)** — added the
...
10. **Phase 8 — Increment 3: order reconciliation engine (2026-09-15)** — added
...
11. **Phase 8 — Increment 2: API brokers module + env-backed registry (2026-09-15)** — added
...
12. **Phase 8 — Increment 1: `BybitAdapter` (2026-09-15)** — built the Bybit v5 adapter in
...
13. **Persisted per-cycle signals/orders + bot-cycle E2E (2026-09-15)** — added `bot_run_cycles`
...
14. **Fixed three latent defects surfaced by the new E2E** — (a) `MarketsService.getCandles`
...
15. **JWT-guarded the backtests API (2026-09-15)** — closed the auth inconsistency flagged in
